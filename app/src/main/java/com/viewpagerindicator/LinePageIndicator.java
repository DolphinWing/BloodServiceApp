...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    public LinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final boolean defaultSnap = res.getBoolean(R.bool.default_line_indicator_snap);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float cx = horizontalOffset + (mSnap ? mSnapPage : mCurrentPage) * lineWidthAndGap;
        if (!mSnap) {
            cx += mPageOffset * lineWidthAndGap;
        }
        canvas.drawLine(cx, verticalOffset, cx + mLineWidth, verticalOffset, mPaintSelected);
    }
